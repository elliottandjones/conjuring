              ...
              <h1 className="mt1 mb1" style={{ fontSize: '2.2em' }}>
                <a id="homepage" href="/" title="link to home page" style={{ textDecoration: 'none' }}>
                  <span id="app-title-span" style={{ whiteSpace: 'none' }}>
                    Conju
                    <img className="icon" alt="icon" src="/favicon.ico" />
                    ing
                  </span>
                </a>{' '}
                <a href="https://github.com/Elliohknow/conjuring" title="github repo for this web app" id="source-link">
                  source
                </a>
              </h1>
            </div>
        ...
        {!spellFilter && !chatOpen ? (
          <div className="filters-wrapper">
            ...
            <div className="speed-and-size">
              ...
              <footer id="footer">
                &copy; 2019{' '}
                <a href="http://elliottandjones.com/" style={{ textDecoration: 'none' }}>
                  Elliott Jones
                </a>
              </footer>
            </div>
